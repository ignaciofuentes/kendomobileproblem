...
var addToHome = (function (w) {
	...
	function init () {
		...
		lastVisit = +w.sessionStorage.getItem('addToHome');
	...
	function loaded () {
		...
		if ( !isReturningVisitor ) w.sessionStorage.setItem('addToHome', Date.now());
		else if ( options.expire && isExpired ) w.sessionStorage.setItem('addToHome', Date.now() + options.expire * 60000);
	...
	function reset () {
		w.sessionStorage.removeItem('addToHome');
